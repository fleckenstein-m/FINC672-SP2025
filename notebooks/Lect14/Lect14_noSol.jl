...
using CSV, DataFrames, Dates, Statistics, StatsModels, GLM
using Plots
...
# begin
# 	FF = CSV.Read("FFmFactorsPs.csv",DataFrame)
...
# begin
# 	FFPort  = CSV.Read("FF25Ps.csv",DataFrame)
...
# 	filter!(:date => (x-> x>= Dates.Date(1970,01) && x<=Dates.Date(2022,12)) ,FFTestportfolios)
# end
...
manifest_format = "2.0"
project_hash = "fc8dbf1c4024712f47c8cf996f2de163fc092fd9"
