...
# describe(PerfDat, :eltype, :mean, :std, :min, :median, :max, 
...
# ╠═╡ show_logs = false
 ...
 # 	(Rb,RFunds,Rf) = (convert.(Float64,x[:,2:9]),
	#                   convert.(Float64,x[:,10:11]),
...
manifest_format = "2.0"
project_hash = "3fbcc5d3245f9ba060b575b87fdb164100229333"
