...
# ╠═╡ show_logs = false
begin
	using CSV, DataFrames, Dates,  LinearAlgebra,  StatsBase, Statistics, StatsModels
...
# ╔═╡ 25b21c0d-ca53-49a3-acfc-e77a0fc59b61
md"""
OlsGMFn(Y,X)
...
# describe(FF, :eltype, :mean, :std, :min, :median, :max, 
# 	     (x->length(collect(skipmissing(x)))) =>:nobs, :nmissing)
...
# 	Rm = 
# 	Rf = 
# 	R25 = Matrix(FF[:,Between("SMALL LoBM","BIG HiBM")])
...
#  		printmat([b tstat],colNames=["coef","t-stat"],
# 			     rowNames=["constant","slope (down)","slope (up)"])
#  	end
...
# let
# 	xTicksLoc = [Date(1980);Date(1990);Date(2000);Date(2010); Date(2020)]
...
manifest_format = "2.0"
project_hash = "03ff9d2aa96ec384579e59eb2d8c4c8edfe200aa"
