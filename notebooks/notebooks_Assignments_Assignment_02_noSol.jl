...
# ╔═╡ ce1be57b-3d94-4f28-a307-8bafc01d9651
	...
	<p style="padding-bottom:1cm"> </p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Assignment 02 : Call/Put Options </b> <p>
	<p style="padding-bottom:1cm"> </p>
...
# ╠═╡ show_logs = false
begin
	#load the Plots.jl and DataFrames.jl packages
	using Plots
	using DataFrames
end

# ╔═╡ cbfb0e60-1abf-4702-8fc7-639b97dfa949
vspace
...
md"""
Let $K$ be the strike price and  $S_T$ the price of the underlying at expiration ($T$ years ahead) of the option contract. Assume that the (continuously-compounded) discount rate is $r$.

The call and put profits (at expiration) are

$\textrm{Call Profit} = \max(0,S_T - K) - e^{r T} C$

$\textrm{Put Profit} = \max(0, K-S_T) - e^{r T} P$

where $C$ ($P$) is the call (put) option price paid today. The first term $\max()$ represents the payoff at expiration, while the second term $e^{r T}C$ ($e^{r T}P$) subtracts the capitalized value of the option price (premium) paid at inception of the contract.

"""

# ╔═╡ 19f99b75-4faa-483d-886b-df4d1a484eb0
vspace

# ╔═╡ ef77dbe7-3f81-4500-9010-1668fe05f749
md"""
**We are given the following data.**
"""

# ╔═╡ 02b31c87-173d-44d6-b5ef-ada7179e8657
begin
	ST = [4.5,5.5]         #possible values of underlying at expiration
	K  = 5                 #strike price
	C  = 0.4               #call price
	P  = 0.4               #pur price
	(r,T) = (0,1)          #assume r=0, T=1 year to expiration
end

# ╔═╡ dec08784-bad9-4d68-a344-d50caf3e009a
vspace

# ╔═╡ c0de4cd2-c39d-45f9-8399-290f6195c8d8
md"""
## Question  1
1. Calculate the payoff of the call option for each realization of the underlying.
2. Calculate the profit of the call option for each realization of the underlying.
3. Create an indicator variable which takes the value "yes" if the call option is exercised, and "no" otherwise.
4. Display your results in table format. 
"""
...
# ╔═╡ 7d3ec5b6-8cd5-4d3c-9995-fe7a3da81c76
vspace

# ╔═╡ 113631fc-fa0f-4aea-b301-c85b0124c57d
with_terminal() do
	println("Payoff and profit of a call option :\n")
end

# ╔═╡ 39f82397-0b15-4b25-bcc3-2395ae36c9dd


# ╔═╡ cb1f3e8c-2946-4e2e-b460-93d1ea2e4025
vspace

# ╔═╡ edaa81dd-3344-4631-86ea-b7176f682231
md"""
## Question 2
Plot the profit of the call option when the strike price is $K for a range of asset prices at expiration from 0 to 10,

*Note: the profit is on the vertical axis and the asset price at expiration is on the horizontal axis.* 

"""

# ╔═╡ d8710347-6be9-4f8a-be0e-851c3f78262b
vspace
...
# ╔═╡ 8ab2f662-29ca-44a5-a50a-97393cd3741f
vspace

# ╔═╡ 2ea5e043-92ce-4ab7-b6b9-0a18000fa75d
md"""
## Question  3
1. Calculate the payoff of the put option for each realization of the underlying.
2. Calculate the profit of the put option for each realization of the underlying.
3. Create an indicator variable which takes the value "yes" if the put option is exercised, and "no" otherwise.
4. Display your results in table format.
"""

# ╔═╡ 2f3a84f1-7e37-4fcd-8b8c-a5b46a37036b
# ╠═╡ show_logs = false
begin
...
# ╔═╡ 426af741-5e9e-4b9d-9027-3b44fbc86b1a


# ╔═╡ c88406ac-3e1d-4926-8097-0e315400487b
vspace

# ╔═╡ dc1811a9-8d74-401d-8475-a47724e6fefa
md"""
## Question 4
In a single figure, plot
1. the profit of the call option when the strike price is 5. 
2. the profit of the put option when the strike price is 5.

"""

# ╔═╡ 791ba0b4-4c6b-42f4-a3ff-603e670c57f8
vspace

# ╔═╡ 65292126-0ac4-4401-aa2e-852b87edd180
let
...
# ╔═╡ b00070b4-891c-4b3c-a0cd-d5cdb33818d1
vspace

# ╔═╡ 1a17c61e-77f2-4673-b1c2-00b7a7bd08ac
md"""
## Question 5
Plot the profit function of a straddle when the strike price is 5. Note that a straddle is simply a long call and a long put with the same strike and time to expiration.
"""

# ╔═╡ 53fc855d-9f38-4315-b819-d41401a9ddcf
vspace

# ╔═╡ e33c160d-07fe-43a1-a679-f765714de032
let 
	S = 0:0.1:10          
	
end

# ╔═╡ 2bfe5e44-c9d8-4acf-9517-1764e48ccc7a
vspace
...
manifest_format = "2.0"
project_hash = "317e57801e1853f9a58db64253390e16b5f5d9f9"
